    ...
    return (
        <div className="relative w-[calc(100%-2rem)] h-full m-4">
            ...
            <div className="relative w-full h-full flex flex-col lg:flex-row">
                <div className={`w-full ${video ? 'lg:w-1/2' : 'lg:w-full'} h-full flex flex-col justify-center ${video ? 'items-center text-center lg:text-left lg:items-left' : ''} p-10 ${video ? 'mt-16' : ''} lg:mt-0`}>
                    {pillText && (
